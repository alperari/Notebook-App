	...
	<tbody>
		<?php
			...
			while($row = mysqli_fetch_assoc($result)){
				...
				$name = $row['name'];
				$email = $row['e_mail'];
				echo "<tr>"."<td>".$id."<td>".$nick."<td>".$pwd."<td>".$name."<td>".$email."<td>"."<form action = '' method = 'POST'>".
				"<input type = 'hidden' value=".$id." name = 'delete'>"."<button style = 'background-color: #ea061d;'> Delete </button>"."</form>" ."<tr>";
			}
...
<table class="container">
	...
	<tbody>
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			."<td>".$cname."<td>"."<button style = 'background-color: #ea061d;' type='button', >Delete</button>"."<tr>";
		}
		?>
		<tr>
			<td><span class="label">Id</span></td>
			...
			<td><button style = 'background-color: #1fee0c;'type="button ">Add</button></td>
		</tr>
	</tbody>
</table>
<table class = "container">
	...
	<tbody>
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			$price = $row['price'];
			$date = $row['date'];
			echo "<tr>"."<td>".$oid."<td>".$price."<td>".$date."<td>"."<button style = 'background-color: #ea061d;' type='button', >Delete</button>"."<tr>";			
		}
		?>
		<tr>
